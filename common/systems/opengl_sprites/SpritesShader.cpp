...
namespace kengine {
	...
	static void drawObject(EntityManager & em, const GraphicsComponent & graphics, const TransformComponent3f & transform, Uniforms uniforms, bool in2D = false) {
...

		{
			...
			auto centre = toVec(transform.boundingBox.topLeft);
			if (in2D) {
				centre.y = 1 - centre.y;
